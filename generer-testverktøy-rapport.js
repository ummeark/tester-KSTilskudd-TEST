...
const utPath    = path.join(docsDir, 'testverktoy-rapport.html');
...
<div class="container">
  ...
  <div class="rapport-header">
    ...
    <div class="nav-knapper">
      ...
      <a href="testverktoy-rapport.html" class="knapp aktiv">Test av testverktøy</a>
    </div>
  </div>
...
console.log(`✅ testverktoy-rapport.html generert → ${utPath}`);
